...
.⃟𖥔 ݁. 𖦹˙— \`\`STRAWBERRY MENU\`\` —˙𖦹.🍓꒷

── *👤 PERFIL* ╏
👤 ➛ Usuario: @${taguser.split('@')[0]} pe
👑 ➛ Owner: ${ownerTag} - Andreitap'
📱 ➛ Bot: +${numBot}
...
`
  ...
  menu += `
── *📝 AYUDA* ╏
💡 ➛ Usa ${usedPrefix} antes de cada comando pe
💡 ➛ Ejemplo: ${usedPrefix}sticker
> _"Dulce como fresita"_ 🍓
...
━━━━━━━━━━━`
  ...
  await conn.sendMessage(m.chat, {
    image: img,
    caption: menu,
    mentions: [taguser, owner + '@s.whatsapp.net']
  }, { quoted: m })
